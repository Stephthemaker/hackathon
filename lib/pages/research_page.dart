...
class _GroupsSection extends StatelessWidget {
  ...
  static const _groups = [
    _RG(
      ...
      members: [
        _Member('Willem Bester', 'assets/staff/academic/whkbester.jpg'),
        _Member('Walter Schulze', null),
        _Member('Brink van der Merwe', 'assets/staff/academic/abvdm.jpg'),
        _Member('Steyn van Litsenborgh', null),
        _Member('Lynette van Zijl', 'assets/staff/academic/lvzijl.jpg'),
      ],
    ...
    _RG(
      ...
      members: [
        ...
        _Member('Bernd Fischer', 'assets/staff/academic/bfischer.jpg'),
        _Member('Jaco Geldenhuys', null),
        _Member('Cornelia Inggs', 'assets/staff/academic/cinggs.jpg'),
        _Member('Zhunaid Mohamed', null),
        _Member('Jan Taljaard', null),
        _Member('Phillip van Heerden', null),
        _Member('Willem Visser', 'assets/staff/academic/visserw.jpg'),
      ],
    ...
    _RG(
      ...
      members: [
        ...
        _Member('Trienko Grobler', 'assets/staff/academic/tlgrobler.jpg'),
        _Member('Steve Kroon', 'assets/staff/academic/kroon.jpg'),
        _Member('Jordan Masakuna', null),
        _Member('Arnu Pretorius', null),
        _Member('Charl Steyl', null),
        _Member('Elan van Biljon', null),
        _Member('Andries Engelbrecht', 'assets/staff/academic/engel.jpg'),
      ],
